...
I also added small information to a bus stop at 181st and Amsterdame and set the _MTA_ as the ownee of the bus stop. This was a little confusing as the options are not so straight forward. For example, there is a _Network_ option which states that it is a "system of roots" but I am not sure if this is the same as the name of the bus. 
